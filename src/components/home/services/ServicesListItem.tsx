...
const ServicesListItem = (props: Props) => {
	return (
		<div className="flex flex-col items-center gap-10 px-5 py-14 duration-200 bg-white shadow-xl cursor-default lg:flex-row hover:shadow-blue-200 rounded-xl justify-center">
